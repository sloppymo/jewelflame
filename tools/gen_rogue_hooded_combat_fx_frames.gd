...
# Source: assets/Citizens-Guards-Warriors/Rogues/Hooded/rogue_hooded_combat_fx.png
# Note: 6 columns (wider sprites with effects)

func _run() -> void:
	print("Generating Hooded Rogue Combat (With FX) SpriteFrames...")
	
	var sprite_frames := SpriteFrames.new()
	
	var texture: Texture2D = load("res://assets/Citizens-Guards-Warriors/Rogues/Hooded/rogue_hooded_combat_fx.png")
	if not texture:
	...
	var output_path := "res://assets/animations/rogue_hooded_combat_fx.tres"

...
# Mage (Red) Non-Combat SpriteFrames Generator
# Frame size: 16x16
# Directions: right, left, down, up (4 rows per animation group)
# Source: assets/Citizens-Guards-Warriors/Mages/RED/Mage_Fem_Red.png

func _run() -> void:
	print("Generating Mage (Red) Non-Combat SpriteFrames...")
	
	var sprite_frames := SpriteFrames.new()
	
	var texture: Texture2D = load("res://assets/Citizens-Guards-Warriors/Mages/RED/Mage_Fem_Red.png")
	if not texture:
		print("ERROR: Could not load mage texture!")
		return
	...
	var output_path := "res://assets/animations/mage_red_non_combat.tres"

...
# Mage Masculine (Dark Grey) Combat SpriteFrames Generator
# Frame size: 32x32 (combat sprites are larger)
# Directions: n, ne, e, se, s, sw, w, nw (8 directions)
# Source: assets/Citizens-Guards-Warriors/Mages/Mage_Masc_DKGREY-Combat.png

func _run() -> void:
	print("Generating Mage Masculine (Dark Grey) Combat SpriteFrames...")
	
	var sprite_frames := SpriteFrames.new()
	
	var texture: Texture2D = load("res://assets/Citizens-Guards-Warriors/Mages/Mage_Masc_DKGREY-Combat.png")
	if not texture:
		print("ERROR: Could not load mage masc dark grey combat texture!")
		return
	...
	var output_path := "res://assets/animations/mage_masc_dkgrey_combat.tres"

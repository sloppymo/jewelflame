...
## Generates: res://assets/animations/paladin_combat.tres
## Source: Paladin_Combat_32x32_7a5cd6.png
## Specs: 128×384 px, 32×32 frames, 4 cols × 12 rows

func _run() -> void:
	var tex_path := "res://assets/Citizens - Guards - Warriors/Warriors/Paladin_Combat_32x32_7a5cd6.png"
	var out_path := "res://assets/animations/paladin_combat.tres"

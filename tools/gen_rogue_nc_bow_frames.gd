...
# Source: assets/Citizens-Guards-Warriors/Rogues/Regular/rogue_nc_bow.png

func _run() -> void:
	print("Generating Rogue Non-Combat Bow SpriteFrames...")
	
	var sprite_frames := SpriteFrames.new()
	
	var texture: Texture2D = load("res://assets/Citizens-Guards-Warriors/Rogues/Regular/rogue_nc_bow.png")
	if not texture:
	...
	var output_path := "res://assets/animations/rogue_nc_bow.tres"

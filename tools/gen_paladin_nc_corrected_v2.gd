...
## Paladin Non-Combat Generator - CORRECTED v2
## Row order: down, up, right, left (verified)
...
func _run() -> void:
	...
	# CORRECT direction order: down, up, right, left
	...
	if err == OK:
		print("[OK] Saved CORRECTED Paladin NC v2: ", out_path)

...
# Mage Hooded (Brown) Non-Combat SpriteFrames Generator
# Frame size: 16x16
# Directions: right, left, down, up (4 rows per animation group)
# Source: assets/Citizens-Guards-Warriors/Mages/Mage_Hooded_BROWN.png

func _run() -> void:
	print("Generating Mage Hooded (Brown) Non-Combat SpriteFrames...")
	
	var sprite_frames := SpriteFrames.new()
	
	var texture: Texture2D = load("res://assets/Citizens-Guards-Warriors/Mages/Mage_Hooded_BROWN.png")
	if not texture:
		print("ERROR: Could not load mage hooded brown texture!")
		return
	...
	var output_path := "res://assets/animations/mage_hooded_brown_non_combat.tres"

...
# Mage Masculine (Dark Grey) Non-Combat SpriteFrames Generator
# Frame size: 16x16
# Directions: right, left, down, up (4 rows per animation group)
# Source: assets/Citizens-Guards-Warriors/Mages/Mage_Masc_DKGREY.png

func _run() -> void:
	print("Generating Mage Masculine (Dark Grey) Non-Combat SpriteFrames...")
	
	var sprite_frames := SpriteFrames.new()
	
	var texture: Texture2D = load("res://assets/Citizens-Guards-Warriors/Mages/Mage_Masc_DKGREY.png")
	if not texture:
		print("ERROR: Could not load mage masc dark grey texture!")
		return
	...
	var output_path := "res://assets/animations/mage_masc_dkgrey_non_combat.tres"

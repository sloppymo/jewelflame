...
# Source: assets/Citizens-Guards-Warriors/Rogues/Regular/rogue_combat_no_fx.png

func _run() -> void:
	print("Generating Rogue Combat (No FX) SpriteFrames...")
	
	var sprite_frames := SpriteFrames.new()
	
	var texture: Texture2D = load("res://assets/Citizens-Guards-Warriors/Rogues/Regular/rogue_combat_no_fx.png")
	if not texture:
	...
	var output_path := "res://assets/animations/rogue_combat_no_fx.tres"
